 ...
 * @Create: 2021/11/9
 **/
class QuickRecycleViewItemClickClassVisitor(cv: ClassVisitor, lambdaList: MutableList<String>?) :
    ...
    override fun listenerInterface() = "com/chad/library/adapter/base/listener/OnItemClickListener"

    override fun listenerFunction() = "onItemClick"

    override fun listenerFunctionDescriptor() =
    ...
    override fun insertEnterByteCode(mv: BaseMethodVisitor) {
        BehaviorHelper(mv)
            .buildEvent(BehaviorHelper.BuildStringLocalCode { "rv_item_click" })
            .buildData {
